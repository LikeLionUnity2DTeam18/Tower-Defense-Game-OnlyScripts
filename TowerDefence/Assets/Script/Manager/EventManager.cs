...
/// 리스너 등록
///     EventManager.AddListner<이벤트이름>(이벤트를 메서드 명)
/// 트리거 발동
///     EventManager.Trigger(new 이벤트이름 구조체 생성)
///     EX) EventManager.Trigger(new PlayerHealthChanged { prevHealth = 20, changedHealth = 10 });
/// 이벤트를 사용할 메서드 정의
